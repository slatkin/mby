...
- [x] 4.2 Sync the applied deltas into `openspec/specs/` (new `headless-playback-memory-footprint`, modified `video-feed-playback-buffering`) and archive the change. Verify `openspec validate` reports no errors.
